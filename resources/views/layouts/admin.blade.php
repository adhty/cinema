    ...
    <div class="d-flex">
        ...
        <aside class="bg-dark text-white p-3" style="width:250px;">
            ...
            <ul class="nav flex-column">
                ...
                {{-- 🔹 Manajemen User (Expandable Menu) --}}
                <li class="nav-item mb-2">
                    <a href="#userSubmenu"
                        data-bs-toggle="collapse"
                        class="nav-link text-white d-flex justify-content-between align-items-center {{ request()->routeIs('admin.users.*') || request()->routeIs('admin.roles.*') ? '' : 'collapsed' }}">
                        <span><i class="fa-solid fa-users me-2"></i> Manajemen User</span>
                        <i class="fa-solid fa-chevron-down small"></i>
                    </a>
                    <ul class="collapse nav flex-column ms-3 {{ request()->routeIs('admin.users.*') || request()->routeIs('admin.roles.*') ? 'show' : '' }}" id="userSubmenu">
                        <li class="nav-item">
                            <a href="#}"
                                class="nav-link text-white py-1 {{ request()->routeIs('admin.roles.*') ? 'active' : '' }}">
                                <i class="fa-solid fa-key me-2"></i> Hak Akses
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.users.index') }}"
                                class="nav-link text-white py-1 {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                                <i class="fa-solid fa-user-gear me-2"></i> Daftar Pengguna Cinema
                            </a>
                        </li>
                    </ul>
                </li>
