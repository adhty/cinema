...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('admin.dashboard') }}">Dashboard Cinema</a>
    ...
    <div class="d-flex">
        ...
        <aside class="bg-dark text-white p-3" style="width:250px; min-height:100vh;">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                    <a href="{{ route('admin.cinemas.index') }}" class="nav-link text-white">Cinema Prices</a>
                </li>
                <li class="nav-item mb-2">
                    <a href="{{ route('admin.movies.index') }}" class="nav-link text-white">Movies</a>
                </li>
                <li class="nav-item mb-2">
                    <a href="{{ route('admin.actors.index') }}" class="nav-link text-white">Actors</a>
                </li>
                <li class="nav-item mb-2">
                ...
                {{-- Promos (terpisah karena tidak ada FK langsung) --}}
                <li class="nav-item mb-2">
